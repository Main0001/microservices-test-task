...
REST API сервис для создания счетов-фактур (инвойсов), генерации PDF и отправки на email.
...
```json
{
  ...
  "items": [
    { "description": "Дизайн логотипа", "amount": 150.0 },
    { "description": "Вёрстка сайта", "amount": 350.0 }
  ]
}
```
